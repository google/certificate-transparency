...
from ct.client.log_client import LogProber
...
gflags.DEFINE_spaceseplist('ct_server_list', "https://ct.googleapis.com/pilot",
                           "List of CT servers to monitor")
gflags.DEFINE_string('ct_mongo_db', "ct", "CT database")
