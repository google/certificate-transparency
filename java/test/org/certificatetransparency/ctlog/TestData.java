...
public class TestData {
  ...
  public static final String TEST_LOG_KEY_RSA = DATA_ROOT + "ct-server-key-public-rsa.pem";
  // Root CA cert.
  ...
  public static final String TEST_CERT_SCT_RSA = DATA_ROOT + "test-cert-rsa.proof";
  ...
  public static final String TEST_PRE_SCT_RSA = DATA_ROOT + "test-embedded-pre-cert-rsa.proof";
