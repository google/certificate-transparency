...
TEST_F(CounterTest, TestCounterName) {
  std::unique_ptr<PrometheusCounter<>> counter(
...
TEST_F(CounterTest, TestCounterLabelNames) {
  std::unique_ptr<PrometheusCounter<string, string, int>> counter(
      PrometheusCounter<string, string, int>::New("name", "one", "two",
                                                  "three", "help"));
...
TEST_F(CounterTest, TestCounterWithLabels) {
  std::unique_ptr<PrometheusCounter<std::string, int>> counter(
      PrometheusCounter<std::string, int>::New("name", "a string", "an int",
                                               "help"));
